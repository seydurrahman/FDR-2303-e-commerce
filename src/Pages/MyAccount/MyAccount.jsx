...
const MyAccount = () => {
  useEffect(() => {
    async function x (){
        ...
        const q = query(
          citiesRef,
          where("EmailAddress", "==", "seydur.rahman82@gmail.com"),
        );
        console.log(q);
      ...
      <div className="my-4 flex flex-col space-y-4 2xl:flex-row 2xl:space-x-4 2xl:space-y-0">
        <div className="flex w-full flex-col 2xl:w-1/3">
          ...
          <div className="mt-4 flex-1 rounded-lg bg-white p-8 shadow-xl">
            ...
            <div className="relative px-4">
              <div className="border-secondary absolute h-full border border-dashed border-opacity-20"></div>
        ...
        <div className="flex w-full flex-col 2xl:w-2/3">
          ...
          <div className="mt-4 flex-1 rounded-lg bg-white p-8 shadow-xl">
            ...
            <div className="mt-4">
              <canvas id="verticalBarChart" width="1656" height="828"></canvas>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="mt-8 grid grid-cols-2 gap-8 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Frances Mather</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Donna Serrano</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Randall Tabron</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">John McCleary</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Amanda Noble</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Christine Drew</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Lucas Bell</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Debra Herring</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Maria Heal</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Edward Ice</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Jeffery Silver</p>
            <p className="text-center text-xs text-gray-500">
          ...
          >
            <img
              ...
              className="w-16 rounded-full"
            />
            <p className="mt-1 text-center text-sm font-bold">Joseph Marlatt</p>
            <p className="text-center text-xs text-gray-500">
